 ...
 */
public abstract class QuestionTimer {
    ...
    QuestionTimer(long millisOnTimer, long countDownInterval, boolean runAtStart) {
     ...
     */
    public synchronized final QuestionTimer create() {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (QuestionTimer.this) {
